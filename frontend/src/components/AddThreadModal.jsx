...
const AddThreadModal = ({ showAddThreadModal, setShowAddThreadModal, threads, setThreads }) => {
    ...
    const addToThread = (e) => {
        ...
        tempThread.push({
            ...
            tLlegada: data.arrivalTime !== "" ? data.arrivalTime : 0,
            cpu: data.cpu,
            prioridad: data.arrivalTime !== "" ? data.priority : 0
        });
    ...
    return (
        <Modal preventScroll={false} style={customStyles} isOpen={showAddThreadModal} closeTimeoutMS={500} shouldCloseOnEsc={true} shouldCloseOnOverlayClick={true} onRequestClose={() => setShowAddThreadModal(false)}>
            ...
            <div className="modal-body d-flex flex-column">
                ...
                <div className='d-flex flex-row'>
                    <div className="flex-fill">
                        ...
                        <input required onChange={(e) => handleInputChange(e)} value={data.threadName} name='threadName' type="text" id="nombreHiloRegister" className="form-control" placeholder="Ej. Hilo 1" />
                    </div>
                </div>
                ...
                <form onSubmit={(e) => addToThread(e)} className="d-flex flex-column">
                    ...
                    <button type='submit' className="btn btn-secondary col-md-12 mt-3 mb-2">Agregar Proceso</button>
            ...
            <div className="modal-footer">
                ...
                <button type="button" id="btnGuardarHilo" className="btn btn-primary">Guardar Hilo</button>
            </div>
        </Modal>
    )
}

...
const PSAInputs = ({ setProcessStatesHistory, setStatesHistoryTable, outputRef, setProcessesList, setSelectedAlgorithm, setQuantum }) => {
    ...
    return (
        <form id='setup' onSubmit={(e) => onSubmit(e)}>
            ...
            <div className="d-flex flex-row mt-3">
                <button form='setup' id='run' className="form-control btn btn-primary" type='submit'>Ejecutar</button>
            </div>
            {processes.length !== 0 &&
                <div>

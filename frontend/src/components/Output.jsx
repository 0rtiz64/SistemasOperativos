...
import RefsTable from './algorithms/Page replacement/RefsTable'
import Statistics from './algorithms/Page replacement/Statistics'

const Output = ({ table, refs, frames, type, statesHistoryTable, setStatesHistoryTable, processStatesHistory, setProcessStatesHistory, outputRef, selectedAlgorithm, processes, setProcesses, quantum }) => {
                    ...
                    <React.Fragment>
                        {
                            table.stacks.length !== 0 ?
                                <section className='d-flex flex-column mt-2'>
                                    ...
                                    <div className="tab-content" id="myTabContent">
                                        <div className="tab-pane fade show mt-2 table-responsive active" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                                            <RefsTable refs={refs} frames={frames} table={table} showBits={true} />
                                        </div>
                                        <Statistics table={table} refs={refs} />
                                    </div>

                                </section>
                                :
                                <div className='text-center text-muted mt-4'>
                                    La gráfica y estadísticas se mostraran aquí.
                                </div>
                        }
                    </React.Fragment>
                }
